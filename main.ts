...
function Round_5 () {
    ...
    timer.after(10, function () {
        ...
        game.setDialogCursor(img`
            ...
            ........fefeffef........
            `)
        game.showLongText("You did it! you saved your home, but the rest of the forest is a parking lot :(", DialogLayout.Bottom)
        game.over(true)
    })
}
...
let BullDozer_right: Sprite = null
...
game.onUpdateInterval(3000, function () {
    BullDozer_right = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . 5 5 . . . . . . . . . . . . . 
        ...
        . . . . f f . . . . . . f f . . 
        `, SpriteKind.Enemy)
    BullDozer_right.x = scene.screenWidth()
    BullDozer_right.vx = -10
    BullDozer_right.y = randint(10, scene.screenHeight() - 10)
    status_bar_BullDozer = statusbars.create(50, 2, StatusBarKind.EnemyHealth)
    status_bar_BullDozer.setColor(5, 12)
    status_bar_BullDozer.max = 100
    status_bar_BullDozer.attachToSprite(BullDozer_right)
})
